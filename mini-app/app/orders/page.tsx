      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{
            ...
            {/* 状态筛选 */}
            <div style={{ display: 'flex', gap: 8, overflowX: 'auto', paddingBottom: 2, marginBottom: 14, scrollbarWidth: 'none' }}>
              {STATUS_TABS.map(tab => {
            ...
            <div style={{
              ...
              <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="#8A9690" strokeWidth="2">
              ...
              />
              {search && (
                <button onClick={() => setSearch('')} style={{ background: 'none', border: 'none', cursor: 'pointer', color: '#8A9690', fontSize: 18, lineHeight: 1 }}>×</button>
              )}
            </div>
          </div>
          ...
          {loading ? (
            ...
            <div style={{ background: '#fff', borderRadius: 24, boxShadow: '0 2px 14px rgba(0,0,0,0.055)' }}>
              <EmptyState
                ...
                description={search ? '试试其他搜索关键词' : '快去逐选中意商品吧'}
              />
            </div>
          ) : (
